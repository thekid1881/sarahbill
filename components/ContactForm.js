...
export default function ContactForm() {
  ...
  const apiKey = process.env.PUBLIC_ACCESS_KEY || "179b7c2a-1293-4ff9-acfa-771850fa1ed9";
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="w-xl md:w-2xl my-2 md:my-6 bg-[#82a5dd] p-4 md:p-4 rounded-md">
        <input
          type="checkbox"
          id=""
          className="hidden"
